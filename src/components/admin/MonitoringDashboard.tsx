...
export function MonitoringDashboard() {
    ...
    try {
      ...
      if (errorsResponse.ok && performanceResponse.ok) {
        ...
        const errorStats = {
          ...
          last24h: errorsData.errors?.filter((e: ErrorLog) => {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      case 'page': return 'text-orange-600 bg-orange-50';
      case 'api': return 'text-blue-600 bg-blue-50';
      case 'component': return 'text-gray-600 bg-gray-50';
      default: return 'text-gray-600 bg-gray-50';
    }
  };
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRatingColor(metric.rating)}`}>
                          {metric.rating}
                        </span>
                      </div>
                      <div className="mt-2 flex items-center text-sm text-gray-500 space-x-4">
