...
export const LazyProductManagement = dynamic(() => import("./ProductManagement"), {
  loading: () => (
...
export const LazyOrderManagement = dynamic(() => import("./OrderManagement"), {
  loading: () => (
    <div className="flex items-center justify-center p-8">
      <LoadingSpinner size="lg" />
...
export const LazyInventoryManagement = dynamic(() => import("./InventoryManagement"), {
  loading: () => (
    <div className="flex items-center justify-center p-8">
      <LoadingSpinner size="lg" />
...
export const LazyProductForm = dynamic(() => import("./ProductForm"), {
  loading: () => (
    <div className="flex items-center justify-center p-8">
      <LoadingSpinner size="lg" />
