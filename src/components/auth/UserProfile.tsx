...
export function UserProfile() {
  ...
  const handlePreferenceChange = (category: keyof UserPreferences, key: string, value: boolean | string) => {
    setPreferences(prev => ({
      ...prev,
      [category]: {
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end">
                ...
                >
                  {updateLoading
                    ? (locale === 'cs' ? 'Ukládání...' : 'Saving...')
                    : (locale === 'cs' ? 'Uložit adresy' : 'Save Addresses')
                  }
                </Button>
              </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePreferenceChange('emailNotifications', 'orderUpdates', e.target.checked)}
                  ...
                  <label className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePreferenceChange('emailNotifications', 'promotions', e.target.checked)}
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                  </label>
                  <label className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePreferenceChange('emailNotifications', 'newsletter', e.target.checked)}
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                  </label>
                </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePreferenceChange('smsNotifications', 'orderUpdates', e.target.checked)}
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                  </label>
                  <label className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePreferenceChange('smsNotifications', 'deliveryReminders', e.target.checked)}
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                  </label>
                </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePreferenceChange('privacy', 'shareDataForMarketing', e.target.checked)}
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                  </label>
                  <label className="flex items-center justify-between">
              ...
              <div className="flex justify-end">
                ...
                >
                  {updateLoading
                    ? (locale === 'cs' ? 'Ukládání...' : 'Saving...')
                    : (locale === 'cs' ? 'Uložit nastavení' : 'Save Preferences')
                  }
                </Button>
              </div>
            </div>
