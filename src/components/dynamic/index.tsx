...
export const RouteComponents = {
  ...
  checkout: {
    ...
    PaymentStep: dynamic(
      () =>
        import("@/components/checkout/steps/PaymentStep").then((mod) => ({
          default: mod.PaymentStep,
        })),
      {
        loading: () => <LoadingSpinner size="md" />,
        ssr: false,
