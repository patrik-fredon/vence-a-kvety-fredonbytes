...
} from "@/components/accessibility/KeyboardNavigationGrid";
...
describe("Accessibility Compliance Tests", () => {
  describe("Button Component", () => {
    ...
    it("should have proper ARIA attributes when loading", async () => {
      render(
        <TestWrapper>
          <Button loading loadingText="Načítání...">
            Test Button
          </Button>
        </TestWrapper>
      );
  ...
  describe("FormField Component", () => {
    it("should not have accessibility violations", async () => {
      const { container } = render(
        <TestWrapper>
          <FormField label="Test Input" helpText="This is help text" required />
        </TestWrapper>
      );
  ...
  describe("ProductCard Component", () => {
    ...
    it("should support keyboard navigation", async () => {
      ...
      render(
        <TestWrapper>
          <ProductCard product={mockProduct} locale="cs" onAddToCart={handleAddToCart} />
        </TestWrapper>
      );
