...
export function GradientTest() {
  return (
    <div className="space-y-8 p-8">
      <div>
        <h2 className="text-2xl font-bold mb-4 text-stone-900">Funeral Gold Gradient Test</h2>
        <div className="bg-funeral-gold h-64 rounded-lg flex items-center justify-center">
          <p className="text-2xl font-semibold text-stone-900">bg-funeral-gold</p>
        </div>
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4 text-stone-900">Funeral Teal Gradient Test</h2>
        <div className="bg-funeral-teal h-64 rounded-lg flex items-center justify-center">
          <p className="text-2xl font-semibold text-white">bg-funeral-teal</p>
        </div>
        <p className="mt-2 text-sm text-stone-600">
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4 text-stone-900">Text Readability Test</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-funeral-gold p-6 rounded-lg">
            <h3 className="text-xl font-bold text-stone-900 mb-2">Gold Gradient with Dark Text</h3>
          ...
          <div className="bg-funeral-teal p-6 rounded-lg">
            <h3 className="text-xl font-bold text-white mb-2">Teal Gradient with Light Text</h3>
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4 text-stone-900">Gradient Comparison</h2>
