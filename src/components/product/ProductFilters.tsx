...
import { Category, ProductFilters as ProductFiltersType, ProductSortOptions } from '@/types/product';
...
export function ProductFilters({
  ...
  const handleSortChange = (field: ProductSortOptions['field'], direction?: ProductSortOptions['direction']) => {
    const newSort = {
      field,
