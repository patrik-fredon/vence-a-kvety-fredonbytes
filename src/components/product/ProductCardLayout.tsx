...
export interface ProductCardLayoutProps {
  ...
  children?: React.ReactNode; // For custom content in specific variants
}
    ...
    switch (variant) {
      case "grid":
        return cn(
          ...
          "h-96" // Increased height as per requirements
        );
      ...
      {variant !== "list" && secondaryImage && !imageError && (
        <div className="absolute inset-0 z-10">
          <OptimizedImage
            ...
            className={cn("object-cover transition-all duration-500", !isHovered && "opacity-100")}
