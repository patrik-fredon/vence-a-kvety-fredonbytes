      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <AnimatedCartIcon
              locale={locale}
              className="p-1.5 hover:bg-amber-200 rounded-full transition-colors duration-200"
            />
            ...
            <button
              ...
              className={cn(
                "md:hidden p-2 text-teal-900 hover:text-teal-800 hover:bg-amber-200",
                "transition-all duration-200 rounded-lg",
                isMobileMenuOpen && "bg-amber-200"
              )}
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-stone-200 bg-amber-100">
            ...
            <button
              onClick={closeMobileMenu}
              className="p-2 text-teal-900 hover:text-teal-800 hover:bg-amber-200 transition-colors duration-200 rounded-lg"
