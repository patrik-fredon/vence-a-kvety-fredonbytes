          ...
          <div className="bg-white rounded-lg shadow-soft p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-medium text-neutral-800 mb-1">{tContact("address")}</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-medium text-neutral-800 mb-1">{tContact("phone")}</h3>
                  <a
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-medium text-neutral-800 mb-1">{tContact("email")}</h3>
                  <a
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-medium text-neutral-800 mb-1">{tContact("hours")}</h3>
