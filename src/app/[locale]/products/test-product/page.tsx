...
export default async function TestProductPage({ params }: TestProductPageProps) {
  ...
  const mockProduct: Product = {
    ...
    slug: 'test-product',
    descriptionCs: 'Tradiční pohřební věnec z čerstvých květin s bílými chryzantémami a zelenými listy. Ručně vyráběný našimi zkušenými floristy s důrazem na kvalitu a detail.',
    descriptionEn: 'Traditional funeral wreath made from fresh flowers with white chrysanthemums and green leaves. Handcrafted by our experienced florists with emphasis on quality and detail.',
    basePrice: 1200,
    categoryId: 'cat-1',
    images: [
      {
    ...
    seoMetadata: {
      ...
      description: { cs: 'Tradiční pohřební věnec z čerstvých květin', en: 'Traditional funeral wreath made from fresh flowers' }
    },
    active: true,
    featured: true,
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-blue-800 text-sm">
          <strong>Test Page:</strong> This is a test page to demonstrate the Product Detail and Customization System functionality.
        </p>
      </div>
