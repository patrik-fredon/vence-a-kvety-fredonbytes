...
import { ContactEmailData, AdminNotificationData } from '@/types/contact';
  ...
  return `
    ...
    <body>
      ...
      <div class="content">
        ...
        <div class="highlight">
          <strong>Vaše zpráva byla úspěšně odeslána dne:</strong> ${new Date(data.submittedAt).toLocaleDateString('cs-CZ', {
    year: 'numeric',
    month: 'long',
    day: 'numeric',
    hour: '2-digit',
