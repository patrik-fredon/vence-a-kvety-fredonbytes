...
export function testWreathValidation() {
  ...
  const customizations3: Customization[] = [{ optionId: "ribbon", choiceIds: ["ribbon_yes"] }];
  const test3 = validateWreathConfiguration(customizations3, mockOptions, "size_120", {
    locale: "cs",
  });
  ...
  const test4 = validateWreathConfiguration(customizations4, mockOptions, "size_120", {
    locale: "cs",
  });
  ...
  const test5 = validateWreathConfiguration(customizations5, mockOptions, "size_120", {
    locale: "cs",
  });
