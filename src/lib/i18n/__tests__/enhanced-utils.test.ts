...
import { validateTranslationKey, interpolateTranslation } from '../advanced-utils';
...
describe('Enhanced i18n utilities', () => {
  ...
  describe('translationValidation', () => {
    ...
    it('should detect missing translations', () => {
      expect(translationValidation.hasTranslation(mockMessages, 'common.button.delete')).toBe(false);
