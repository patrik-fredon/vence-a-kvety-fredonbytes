...
// Mock Supabase
const // Removed unused mockSupabaseClient;

// Mock validation functions
const // Removed unused mockValidateCartOperation;

const // Removed unused mockSanitizeCustomizations;

const // Removed unused mockValidateCustomizationIntegrity;

const // Removed unused mockTransferCustomizationsToOrder;

const // Removed unused mockCleanupOrphanedCustomizations;
